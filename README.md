...
Расписать функции согласно алгоритму.

## Оптмизация производительности
Привязать точки параралельности к этапам алгоритма!!!!
...
НА оптимизированном алгоритме.
??? Хорошо бы показать по врешинам и по ребрам с отсечением ненужных и без этого !!!

### Методы целочисленного програмирования (MIP)
Формализация задачи в канонической постановке: переменные, ЦФ и орграничения 
...
Коммерческие тоже включить на малых размерностях одной фразой,  уперлись в ограничения trial-версий.
n = 30
