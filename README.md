...
c_{00}& c_{01} & ...&c_{0N}\\
NULL& c_{11} & ...&c_{1N}\\
NULL& NULL& c_{21} & ...&c_{2N}\\
...\\
NULL& NULL& ...&c_{ij} &... &c_{iN}\\
...\\
NULL& NULL& ...&NULL &c_{NN}\\
\end{vmatrix}
, задающая силу связи между всеми парами объектов. Тогда $X$ - бинарная полуматрица, определяющая вариант группирования объектов. Т.о. каждый элемент матрицы, принимающий единичное значение указывает на то, что соответствующие объекты $i$ и $j$ попадают в одну группу.
