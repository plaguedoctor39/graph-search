...
Если пара объектов i и j в одной группе:$$\[ x_i_j =1 \] , а также объекты j и k в одной группе:$$\[ x_j_k =1 \] $$
, то объекты i и к также должны быть в группе$$\[\rightarrow x_i_k =1 \] $$
