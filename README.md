...
Необходимо объединить задания в  группы не более указанного количества  таким образом, чтобы их директивные интервалы  пересекались наибольшим образом, т.е. полученная группа обладала наибольшей суммарной силой связи.
